...
export const PrivacyPolicyPage: React.FC = () => {
  return (
    <DefaultLayout pageTitle="Privacy Policy">
      <p>
        https://coronavirushelprequest.org operates the
        https://coronavirushelprequest.org website, which provides the SERVICE.
      </p>

      <p>
        This page is used to inform website visitors regarding our policies with
        the collection, use, and disclosure of Personal Information if anyone
        decided to use our Service, the Coronavirus Help Requests website.
      </p>
      ...
      <p>
        ...
        https://coronavirushelprequest.org, unless otherwise defined in this
